...
const CareersComboBox = ({ options, handleSelectedCareer }) => {
    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          ...
          role="combobox"
          aria-expanded={open}
          className="w-[200px] justify-between border-black/20 bg-white outline-none hover:border-blue-400 hover:bg-white hover:text-black"
        >
              ...
              {options.map((option) => (
                <CommandItem
                  ...
                  onSelect={(currentValue) => {
                    ...
                    handleSelectedCareer(option.PROGRAMA)
                    setOpen(false)
                  }}
                >
                  <Check
...
export default CareersComboBox
