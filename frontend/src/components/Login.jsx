...
const Login = () => {
  return (
    <div>
      <div className="flex h-screen flex-col font-roboto md:flex-row">
            ...
            <div className="w-11/12 rounded-lg bg-white p-8 shadow-lg md:w-1/2">
              <form>
                <div className="mt-4">
                  <div>
                    <div>
                      <p className="subtitulo-Login mb-2 flex items-center gap-2 text-xl">
                        Acceso Estudiante
                        <Sheet>
                          <SheetTrigger asChild>
                            <button className="h-8 w-20 hover:bg-white/20">
                              <HelpCircle className="h-4 w-4" color="black" />
                            </button>
                          </SheetTrigger>
                          <SheetContent
                            side={"top"}
                            ...
                            <SheetHeader>
                              ...
                              <SheetDescription>
                                <p className="subtitulo-Login text-base text-gray-900">
                                  Una vez que ingreses, tendrás la oportunidad
                                  de acceder a un completo registro de tu
                                  progreso académico. Esto te permitirá observar
                                  de manera detallada las asignaturas que has
                                  completado con éxito, así como las que todavía
                                  estás cursando o que tienes pendientes de
                                  aprobación. Este sistema brinda una valiosa
                                  visión panorámica de tu rendimiento académico,
                                  lo que te permitirá tomar decisiones más
                                  informadas en cuanto a tu plan de estudios y
                                  tu interacción con las materias que te esperan
                                  en tu carrera.
                                </p>
                                <p className="subtitulo-Login py-2 text-base text-gray-900">
                                  Puedes utilizar esta herramienta para evaluar
                                  tu desarrollo y tener un control completo de
